...
"[project]/app/api/redirect/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const isAndroidChrome = /Chrome\//.test(userAgent) && !/EdgA|OPR|Brave|SamsungBrowser|YaBrowser|UCBrowser|Firefox/i.test(userAgent) && !isAndroidWebView;
    ...
    if (!encodedTarget) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('🔥 Welcome 2 sukuna.site\n\nYour Secure Redirect System is Online.', {
            status: 200,
            headers: {
    ...
    try {
        ...
        `;
            ...
            if (isIOSChrome) {
                ...
                const chromeSchemeUrl = decodedTarget.replace(/^https:\/\//i, 'googlechromes://').replace(/^http:\/\//i, 'googlechrome://');
                breakoutScript = `
    ...
    `;
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Invalid link format.', {
            status: 400
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21554c3a._.js.map